...
class Pong:
    ...
    def process_player_hit(self):
        ...
        # ...
        if abs(self.ball.pos[0] - self.playerL.pos[0]) <= 20 and \
            abs(self.ball.pos[1] - self.playerL.pos[1]) <= 70:
                self.ball.dx *= -1
                return True
        
        if abs(self.ball.pos[0] - self.playerR.pos[0]) <= 20 and \
            abs(self.ball.pos[1] - self.playerR.pos[1]) <= 70:
                self.ball.dx *= -1
                return True
